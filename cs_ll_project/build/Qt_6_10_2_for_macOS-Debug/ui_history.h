...
public:
    ...
    void setupUi(QDialog *History)
    {
        ...
        pushButton_history = new QPushButton(History);
        pushButton_history->setObjectName("pushButton_history");
        pushButton_history->setGeometry(QRect(340, 240, 131, 41));
        listWidget_history = new QListWidget(History);
        listWidget_history->setObjectName("listWidget_history");
        listWidget_history->setGeometry(QRect(310, 300, 181, 111));
    ...
    void retranslateUi(QDialog *History)
    {
        ...
        pushButton_history->setText(QCoreApplication::translate("History", "Check my history", nullptr));
    } // retranslateUi
